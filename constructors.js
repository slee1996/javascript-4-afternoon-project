...
function Car(make, model, year, move){
  ...
  */
  ...
  Movie.prototype.changeRating = function(num){
    var newRating = ((this.rating + num) / 2);
...
User.prototype.addSavedPost = function(id, title, rating){
  ...
  User.prototype.removeSavedPost = function(num){
    var postArr = this.savedPosts
    
    for(var obj in postArr){
      if(postArr[obj].id === num){
        postArr.splice(obj, 1)
      }
    }
    return this.savedPosts = postArr
  }
  ...
  User.prototype.changePostRating = function(num1, num2){
    for(var obj in this.savedPosts){
      if(this.savedPosts[obj].id === num1){
        this.savedPosts[obj].rating = num2
      }
    }
  }
